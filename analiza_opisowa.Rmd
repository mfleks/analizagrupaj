...
```
Kolejnym etapem będzie przedstawienie statystyk opisowych dla zmiennych ilościowych za pomocą zbiorczej tabelki.

```{r}
descr(rowery) #przedstawienie podstawowych statystyk opisowych dla zmiennych numerycznych
```

```{r}
#korelacja pomiedzy zmiennymi ilosciowymi
...
#korelacja pomiedzy zmiennymi jakosciowymi
